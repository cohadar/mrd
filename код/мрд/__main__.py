...
from догађај.мрдачи import Стрелице, Wsad
from дуњалук import Почетак, Крај, Молер, Прозор, Шара, Површ, Воденица
...
class Контејнер(containers.DynamicContainer):
    def __init__(к):
        ...
        к.шкработине = providers.Singleton(Листа, к.шарена_позадина, к._ледена_коцка(), к._плава_коцка(), к.лупа)
    ...
    def _плава_коцка(к):
        ...
        плава_коцка = providers.Singleton(ПлаваКоцка, површ=к.главна_површ, положај=положај)
