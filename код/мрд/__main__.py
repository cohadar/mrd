...
class Контејнер(containers.DynamicContainer):
    def __init__(к):
        ...
        к.крајња_површ = providers.Singleton(Површ, ширина=к.ширина, висина=к.висина, мод=sdl2.SDL_BLENDMODE_BLEND)
        ...
        к.лупа = providers.Singleton(
            ...
            стаклена_површ=к.стаклена_површ,
