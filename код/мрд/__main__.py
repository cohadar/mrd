...
from дуњалук import Почетак, Крај, Молер, Прозор, ГлавнаШара, Воденица, Пиксели
from шкработине import Шкработине, ЦрвенаКоцка, ШаренаПозадина
...
class Контејнер(containers.DynamicContainer):
    def __init__(к):
        ...
        к.шкработине = providers.Singleton(Шкработине, к.шарена_позадина, к.црвена_коцка)
