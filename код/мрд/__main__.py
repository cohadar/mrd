...
from шкработине import Шкработине, ЦрвенаКоцка, ПлаваКоцка, ШаренаПозадина
...
class Контејнер(containers.DynamicContainer):
    def __init__(к):
        ...
        к.шкработине = providers.Singleton(Шкработине, к.шарена_позадина, к.црвена_коцка, к.плава_коцка)
