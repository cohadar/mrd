...
from шкработине import Шкработине, ШаренаПозадина, Лупа
...
class Контејнер(containers.DynamicContainer):
    def __init__(к):
        ...
        к.ледена_коцка = providers.Singleton(
            ЛеденаКоцка, површ=к.главна_површ, обрада_догађаја=к.обрада_догађаја)
        ...
        к.шкработине = providers.Singleton(Шкработине, к.шарена_позадина, к.ледена_коцка, к.плава_коцка, к.лупа)
